...
Expo segue a LGPD (Lei nº 13.709/2018).
...
|---|---|---|
| **Expo** | US | mobile build platform + oauth + mcp |
...
Acessar, corrigir, eliminar, portar, revogar consentimento. Contato: [expo@mcp.ai](mailto:expo@mcp.ai). Reclamações: [ANPD](https://www.gov.br/anpd/pt-br).
